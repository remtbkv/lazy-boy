...
// Playlists' own loading UI. Without this, the parent loading.tsx (the Home shape — greeting,
// action pills, day strip, song rows) would be shown here, which is the wrong page. Mirrors the
// PAGE BODY only — stats line + sort, then the 4-up grid — not the header, which the layout
