...
// Friends' own loading UI — otherwise it inherits the parent /draft skeleton, which is the
// Home shape (day strip, song rows) and looks like the wrong page. Mirrors the real layout:
// a display heading, a lead line, then ruled rows.
