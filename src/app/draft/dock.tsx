      ...
      <div className="hidden flex-wrap items-center gap-1 sm:flex">
        {ACTIONS.map((a) => (
          <button
            ...
            type="button"
            onClick={() => activate(a.key)}
            className="flex h-9 items-center gap-2 rounded-lg border border-border/70 bg-card px-3.5 text-sm font-medium text-foreground/90 transition-colors hover:border-[color-mix(in_srgb,var(--border)_55%,var(--muted-foreground))] hover:bg-accent"
          >
