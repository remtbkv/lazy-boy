...
const TABS = [
  ...
  { key: "friends", href: "/draft/friends", label: "Friends", icon: Disc3 },
] as const;
...
function useActiveTab(): TabKey {
  ...
  if (pathname.startsWith("/draft/playlists")) return "playlists";
  if (pathname.startsWith("/draft/friends")) return "friends";
  return "home";
}
